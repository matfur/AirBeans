...
<main id="about">
  ...
  <p>
    ...
    single origin, and robusta strong to go so dripper. Viennese froth,
    grounds caramelization skinny aromatic cup kopi-luwak, fair trade flavour, frappuccino medium,
  ...
  <p>
    ...
    Seasonal bar shop filter aroma id, crema, affogato viennese cultivar aftertaste, seasonal, percolator cream black,
    galão flavour, milk aromatic turkish skinny crema.
  </p>

  <img class="profile-img" src="@/assets/aboutProfile.png" alt="">
  <h3>Eva Cortado</h3>
  <p class="profile-info">VD & Grundare</p>
</main>
</template>
